...
class Toplevel1: #Everything from line 35-266 is autogenerated, and is purely for GUI setup
    ...
    def onOpen(self): # This method updates the values of the GUI, and logs the newest data, if loggin is enabled. 
        try:
                ...
                externalIMU_data = read_from_externalIMU()
    ...
    def logData(self): # This method is used to enable data logging from SafeEye and M600 to a CSV file. It only runs, when user presses logging button. See L251. Defines the name of the file to which we will log. Also adjusts GUI.
...
def read_from_safeeye(): # This method is used to read data from the onboard IMU
	try:
		temp = ser1.readline() # Read data
		line = temp.decode() # Decode data
		x = line.split() # Comma seperate the data
		return x # Return this
	except Exception as e:
		print("SafeEye serial Read Error")
		
def read_from_externalIMU(): # This method is used to read data from the external IMU
	try:
		temp = ser2.readline() # Read data
		line = temp.decode() # Decode data
		x = line.split() # Comma seperate the data
		return x # Return this
	except Exception as e:
		print("External IMU serial Read Error")
