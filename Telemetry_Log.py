...
class Toplevel1: #Everything from line 35-266 is autogenerated, and is purely for GUI setup
    ...
    def logData(self): # This method is used to enable data logging from SafeEye and M600 to a CSV file. It only runs, when user presses logging button. See L253
