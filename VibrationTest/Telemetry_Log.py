...
class Toplevel1:
    ...
    def onOpen(self):
        with open('Telemetry.json', 'r') as json_file:
            try:
                dict_telemetry = json.loads(json_file.read())
                json_file.close()
            except Exception as e:
                print("Got nothing from JSON")
        ...
        self.Bin_Values.configure(text=str("Vibrations:\n0-100Hz:         " + dict_telemetry["bins"]["bin0"] + "\n100-200Hz:     " +
        dict_telemetry["bins"]["bin1"] + "\n200-300Hz:     " + dict_telemetry["bins"]["bin2"] + "\n300-400Hz:     " + dict_telemetry["bins"]["bin3"] +
        "\n400-500Hz:     " + dict_telemetry["bins"]["bin4"] + "\n500-600Hz:     " + dict_telemetry["bins"]["bin5"] + "\n600-700Hz:     " + dict_telemetry["bins"]["bin6"] +
        "\n700-800Hz:     " + dict_telemetry["bins"]["bin7"] + "\n800-900Hz:     " + dict_telemetry["bins"]["bin8"] + "\n900-1000Hz:   " + dict_telemetry["bins"]["bin9"] +
        "\n1000-1100Hz: " + dict_telemetry["bins"]["bin10"] + "\n1100-1200Hz: " + dict_telemetry["bins"]["bin11"] + "\n1200-1300Hz: " + dict_telemetry["bins"]["bin12"] +
        "\n1300-1400Hz: " + dict_telemetry["bins"]["bin13"] + "\n1400-1500Hz: " + dict_telemetry["bins"]["bin14"] + "\n1500-1600Hz: " + dict_telemetry["bins"]["bin15"]))

        if toLog == True:
                self.log(dict_telemetry)
    ...
    def log(self, arr):
        ...
        fields = [date, arr["rc"]["yaw"], arr["rc"]["throttle"], arr["rc"]["roll"], arr["rc"]["pitch"], arr["imu"]["acceleration"]["x"], arr["imu"]["acceleration"]["y"],
                  arr["imu"]["acceleration"]["z"], dict_telemetry["bins"]["bin0"],dict_telemetry["bins"]["bin1"], dict_telemetry["bins"]["bin2"], dict_telemetry["bins"]["bin3"], 
                  dict_telemetry["bins"]["bin4"], dict_telemetry["bins"]["bin5"], dict_telemetry["bins"]["bin6"], dict_telemetry["bins"]["bin7"], dict_telemetry["bins"]["bin8"], 
                  dict_telemetry["bins"]["bin9"], dict_telemetry["bins"]["bin10"], dict_telemetry["bins"]["bin11"], dict_telemetry["bins"]["bin12"], dict_telemetry["bins"]["bin13"], 
                  dict_telemetry["bins"]["bin14"], dict_telemetry["bins"]["bin15"]]
        print(str(fields))
